...
while 1 do
    ...
    for i = 0, 3 do
        ...
        if enemy_debuffed[i] == 1 then 
            ex3.draw_dynamic_sprite(8*6+4+((timer>>1)&1), 0, enemy_x[i], enemy_y[i], i*2+1)
        elseif enemy_debuffed[i] == 2 then
            ex3.draw_dynamic_sprite(8*6+4+((timer>>2)&1)*2+((timer>>1)&1), 0, enemy_x[i], enemy_y[i], i*2+1)
        else
            ex3.draw_dynamic_sprite(8*6+enemy_rot[i], 0, enemy_x[i], enemy_y[i], i*2+1)
        end
    end
    ...
    for i = 0, 3 do
        if enemy_debuffed[i] then
            if debuff_timer == 150 then
                enemy_debuffed[i] = 2
            elseif debuff_timer == 220 then
                enemy_debuffed[i] = 0
            end
        end
    end
